...
{                               
    ...
    /// 
    /// <para>Syntax errors can also be reported by simply returning false with giving some warnings.</para>
    /// </summary>
        ...
        where State: struct
    {
        ...
        {   
            get
            {
				...
				{
					Raw = _lines.BinarySearch(P)
				};
				if ( pos.Raw < 0 ) {
                    pos.Raw = ~pos.Raw;
                    pos.Column = P - _lines[pos.Raw - 1] + 1;
                } else {
                    pos.Raw++; // 1 base
                    pos.Column = 1;
                }
        ...
        /// <summary>
        /// Initialize <see cref="_lines"/>, which represents line number to 
